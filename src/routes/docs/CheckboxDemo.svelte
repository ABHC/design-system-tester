<script lang="ts">
    ...
    import CheckboxGroup from "../../design-system/components/Checkbox/CheckboxGroup.svelte";
    ...
    const options = $derived(placeholders.checkbox_demo.options);
...
<CheckboxGroup bind:value {options} label_position="right" />

<!-- left -->
<CheckboxGroup bind:value {options} label_position="left" />

<!-- top — group switches to row layout automatically -->
<CheckboxGroup bind:value {options} label_position="top" />

<!-- bottom — group switches to row layout automatically -->
<CheckboxGroup bind:value {options} label_position="bottom" />`;
...
<CheckboxGroup bind:value {options} palette="accent" />`;
</script>

{#snippet codeCell(value: string)}<code>{value}</code>{/snippet}

<div data-summary="demo" data-summary-label={trans?.doc.demo ?? "Demo"}>
    <Headline size="md" uppercase>{trans?.checkbox_demo?.title ?? "Checkbox"}</Headline>
</div>
...
<ControlBar palette="tone">
    ...
    />
    <Selector
        label={trans?.checkbox_demo?.lbl_size ?? "Size"}
        options={["sm", "md", "lg"]}
        bind:value={demo_size}
    />
    <Selector
        label={trans?.checkbox_demo?.lbl_label_position ?? "Label position"}
...
<div class="checkbox-preview">
    <div class="preview-columns">
        ...
        <div class="preview-col">
            <span class="col-label">{trans?.checkbox_demo?.lbl_enabled ?? "Enabled"}</span>
            <CheckboxGroup
        ...
        <!-- Disabled group -->
        <div class="preview-col">
            <span class="col-label">{trans?.checkbox_demo?.lbl_disabled ?? "Disabled"}</span>
            <CheckboxGroup
                value={["tgv"]}
                options={options}
                palette={demo_palette}
        ...
        <!-- Individual disabled -->
        <div class="preview-col">
            <span class="col-label">{trans?.checkbox_demo?.lbl_individual ?? "Individual disabled"}</span>
            <CheckboxGroup
