...
export const translations = {
    fr: {
        ...
        header_demo: {
            title: "Header",
            layout: "Structure",
            preset_editorial: `<strong>Editorial</strong> — <code>leading</code> wordmark, <code>trailing</code> liens texte + CTA primaire. Palette <code>tone</code> ou <code>accent</code>.`,
            preset_app: `<strong>App</strong> — <code>leading</code> logo, <code>trailing</code> <code>Button variant="ghost" palette="tone" squared</code> icône seule. La palette est inversée par rapport au Header pour un contraste optimal.`,
            preset_mixed: `<strong>Mixed</strong> — <code>leading</code> logo, <code>children</code> liens de navigation centrés (slot default), <code>trailing</code> icône + CTA.`,
        ...
        footer_demo: {
            title: "Footer",
            layout: "Structure",
            preset_social: `<strong>Social</strong> — <code>leading</code> icônes de réseaux sociaux, <code>trailing</code> mention légale. Correspond au footer par défaut du layout.`,
            ...
            preset_brand: `<strong>Brand</strong> — <code>leading</code> logo, <code>children</code> liens de navigation centrés, <code>trailing</code> mention légale.`,
        },
        drawer_demo: {
            title: "Drawer",
        },
        ...
        button_demo: {
            ...
            mode_toggle_desc1: "Bascule entre les modes clair et sombre",
            mode_toggle_desc2: "Au clic, inverse la valeur de mode et déclenche onchange.",
        ...
        contrast: {
            ...
            results_title: "Ratios insuffisant",
    ...
    en: {
        ...
        header_demo: {
            title: "Header",
            layout: "Layout",
            preset_editorial: `<strong>Editorial</strong> — <code>leading</code> wordmark, <code>trailing</code> text links + primary CTA. <code>tone</code> or <code>accent</code> palette.`,
            preset_app: `<strong>App</strong> — <code>leading</code> logo, <code>trailing</code> <code>Button variant="ghost" palette="tone" squared</code> icon-only. Palette is inverted relative to the Header for optimal contrast.`,
            preset_mixed: `<strong>Mixed</strong> — <code>leading</code> logo, <code>children</code> centred navigation links (default slot), <code>trailing</code> icon + CTA.`,
        ...
        footer_demo: {
            title: "Footer",
            layout: "Layout",
            preset_social: `<strong>Social</strong> — <code>leading</code> social network icons, <code>trailing</code> legal notice. Matches the default layout footer.`,
            ...
            preset_brand: `<strong>Brand</strong> — <code>leading</code> logo, <code>children</code> centred navigation links, <code>trailing</code> legal notice.`,
        },
        drawer_demo: {
            title: "Drawer",
        },
        ...
        button_demo: {
            ...
            mode_toggle_desc1: "Switch between light and dark modes",
            mode_toggle_desc2: "Clicking flips the mode value and fires onchange.",
        ...
        contrast: {
            ...
            results_title: "Inadequate ratios",
